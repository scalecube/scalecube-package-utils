package io.scalecube.app.loader;
...
public final class ServiceLoaderUtil {
  ...
  /**
   * Finds the first implementation of the given service type using the given predicate
   * to filter out found service types and creates its instance.
   *
   * @param clazz service type
  ...
  /**
   * Finds all implementations of the given service type using the given predicate
   * to filter out found service types and creates their instances.
   *
   * @param clazz service type
   * @param predicate service type predicate
   * @return implementations' set of the given service type
